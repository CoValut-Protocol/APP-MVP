...
export async function POST(request: NextRequest) {
  try {
    ...
    const inscriptionList: any[] = (await axios.get(url2, config2)).data.data.detail;
    const existedInscription = inscriptionList.find((inscription) => inscription.data.tick == ticker.toUpperCase() && inscription.data.amt == amount);
