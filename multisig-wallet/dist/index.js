...
const syndicateVault_1 = __importDefault(require("./routes/syndicateVault"));
...
app.use('/api/airdrop', routes_1.airdropVaultRoute);
...
app.use('/api/syndicate', syndicateVault_1.default);
